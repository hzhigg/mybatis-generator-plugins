 ...
 */
public class UpdateVersionAutoIncreasePlugin extends PluginAdapter {
	...
	public boolean clientGenerated(Interface interfaze, TopLevelClass topLevelClass,
		...
		ibsmethod.setName("updateVersionAutoIncrease");
	...
	public boolean sqlMapDocumentGenerated(Document document, IntrospectedTable introspectedTable) {
		...
		update.addAttribute(new Attribute("id", "updateVersionAutoIncrease"));
		update.addAttribute(new Attribute("parameterType", "java.lang.Long"));
