 ...
 * 2018年12月13日
 */
public class UpdateIsValidListPlugin extends PluginAdapter {
	...
	public boolean clientGenerated(Interface interfaze, TopLevelClass topLevelClass,
		...
		ibsmethod.setName("updateIsValidList");
	...
	public boolean sqlMapDocumentGenerated(Document document, IntrospectedTable introspectedTable) {
        ...
        update.addAttribute(new Attribute("id", "updateIsValidList"));
        ...
        update.addElement(new TextElement(" where id in"));
        ...
        update.addElement(foreachElement);
